...
(function() {
  var MongoStore, app, browserCheck, color, colors, config, connect, cookie_parser, cp, dal, email, email_server, ensureSession, express, http, hydrateSettings, io, jbha, logger, logging, mode, mongoose, port, server, sessionStore, socketio, ss, ssockets, workers, _;
