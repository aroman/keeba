...
(function() {
  var MongoStore, app, browserCheck, color, colors, connect, cookie_parser, cp, email, email_server, ensureSession, express, http, hydrateSettings, io, jbha, logger, logging, mode, mongo_uri, port, secrets, server, sessionStore, socketio, ss, ssockets, workers, _;
