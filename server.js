...
(function() {
  var MongoStore, app, browserCheck, color, colors, config, connect, cookie_parser, cp, dal, email, email_server, ensureSession, ensureSettings, express, http, io, jbha, logger, logging, mode, mongoose, port, server, sessionStore, socketio, ss, ssockets, workers, _;
  ...
  ensureSettings = function(req, res, next) {
  ...
  app.get("/migrate", ensureSession, ensureSettings, function(req, res) {
  ...
  app.post("/migrate", ensureSession, ensureSettings, function(req, res) {
    if (!req.settings.migrate) {
      return res.redirect("/app");
    } else {
  ...
  app.get("/setup", ensureSession, ensureSettings, function(req, res) {
  ...
  app.post("/setup", ensureSession, ensureSettings, function(req, res) {
    var settings;
  ...
  app.get("/app*", ensureSession, ensureSettings, function(req, res) {
