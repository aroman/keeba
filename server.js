...
(function() {
  var MongoStore, app, browserCheck, color, colors, connect, cookie_parser, cp, ensureSession, execSync, express, http, hydrateSettings, io, jbha, logger, logging, mode, mongo_uri, os, port, secrets, server, sessionStore, socketio, ss, ssockets, workers, _;
