...
(function() {
  var MongoStore, RedisStore, app, browserCheck, color, colors, connect, cp, ensureSession, express, fs, hbpc, hydrateSettings, io, jbha, logger, logging, mode, mongo_uri, os, package_info, port, secrets, sessionStore, socketio, workers, _;
