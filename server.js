...
(function() {
  var MongoStore, app, browserCheck, color, colors, connect, cp, ensureSession, express, fs, hbpc, http, hydrateSettings, io, jbha, logger, logging, mode, mongo_uri, os, package_info, port, secrets, server, sessionStore, socketio, ss, ssockets, workers, _;
